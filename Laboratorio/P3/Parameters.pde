...
final float R = 0.1*CONVERSIONM_CM;        // Radio de la partícula (m)
...
final float CR = 5;         // Coeficiente de restitución de las paredes del recipiente
...
final float KD = 0.0004;       // Constante de fricción cuadrática (kg/m)
final float N = 5;                         // Numero de particulas
